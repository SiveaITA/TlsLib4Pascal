...
type
  ...
  public
    /// <summary>Reverses byte order of a 32-bit signed value (endian swap).</summary>
    class function ReverseBytesInt32(AValue: Int32): Int32; static; inline;

    /// <summary>Reverses bit order within a byte (MSB becomes LSB). Bytes are not
    /// swapped or reordered.</summary>
    class function ReverseBitsUInt8(AValue: UInt8): UInt8; static; inline;

    /// <summary>Reverses byte order of a 16-bit value (endian swap).</summary>
    class function ReverseBytesUInt16(AValue: UInt16): UInt16; static; inline;

    /// <summary>Reverses byte order of a 32-bit unsigned value (endian swap).</summary>
    class function ReverseBytesUInt32(AValue: UInt32): UInt32; static; inline;

    /// <summary>Reverses byte order of a 64-bit unsigned value (endian swap).</summary>
    class function ReverseBytesUInt64(AValue: UInt64): UInt64; static; inline;

    /// <summary>Arithmetic right shift of a signed 32-bit value; vacated high bits
    /// replicate the sign bit. Shift count is masked to 31.</summary>
    class function Asr32(AValue: Int32; AShiftBits: Byte): Int32; static; inline;

    /// <summary>Arithmetic right shift of a signed 64-bit value; vacated high bits
    /// replicate the sign bit. Shift count is masked to 63.</summary>
    class function Asr64(AValue: Int64; AShiftBits: Byte): Int64; static; inline;

    /// <summary>Logical left shift by (32 + AShiftBits); AShiftBits must be negative
    /// (callers pass -n for a positive shift distance n).</summary>
    class function NegativeLeftShift32(AValue: UInt32; AShiftBits: Int32): UInt32; static; inline;

    /// <summary>64-bit counterpart of NegativeLeftShift32 (distance 64 + AShiftBits).</summary>
    class function NegativeLeftShift64(AValue: UInt64; AShiftBits: Int32): UInt64; static; inline;

    /// <summary>Logical right shift by (32 + AShiftBits); AShiftBits must be negative.</summary>
    class function NegativeRightShift32(AValue: UInt32; AShiftBits: Int32): UInt32; static; inline;

    /// <summary>64-bit counterpart of NegativeRightShift32 (distance 64 + AShiftBits).</summary>
    class function NegativeRightShift64(AValue: UInt64; AShiftBits: Int32): UInt64; static; inline;

    /// <summary>Rotates an 8-bit value left by AN positions.</summary>
    class function RotateLeft8(AValue: Byte; AN: Int32): Byte; static; inline;

    /// <summary>Rotates a 16-bit value left by AN positions.</summary>
    class function RotateLeft16(AValue: UInt16; AN: Int32): UInt16; static; inline;

    /// <summary>Rotates a 32-bit value left by AN positions.</summary>
    class function RotateLeft32(AValue: UInt32; AN: Int32): UInt32; static; inline;

    /// <summary>Rotates a 64-bit value left by AN positions.</summary>
    class function RotateLeft64(AValue: UInt64; AN: Int32): UInt64; static; inline;

    /// <summary>Rotates an 8-bit value right by AN positions.</summary>
    class function RotateRight8(AValue: Byte; AN: Int32): Byte; static; inline;

    /// <summary>Rotates a 16-bit value right by AN positions.</summary>
    class function RotateRight16(AValue: UInt16; AN: Int32): UInt16; static; inline;

    /// <summary>Rotates a 32-bit value right by AN positions.</summary>
    class function RotateRight32(AValue: UInt32; AN: Int32): UInt32; static; inline;

    /// <summary>Rotates a 64-bit value right by AN positions.</summary>
    class function RotateRight64(AValue: UInt64; AN: Int32): UInt64; static; inline;

    /// <summary>Counts leading zero bits; returns 32 when AValue is zero.</summary>
    class function NumberOfLeadingZeros32(AValue: UInt32): Int32; static; inline;

    /// <summary>Counts leading zero bits; returns 64 when AValue is zero.</summary>
    class function NumberOfLeadingZeros64(AValue: UInt64): Int32; static; inline;

    /// <summary>Counts trailing zero bits; returns 32 when AValue is zero.</summary>
    class function NumberOfTrailingZeros32(AValue: UInt32): Int32; static; inline;

    /// <summary>Counts trailing zero bits; returns 64 when AValue is zero.</summary>
    class function NumberOfTrailingZeros64(AValue: UInt64): Int32; static; inline;

    /// <summary>Population count (Hamming weight) of a 32-bit value.</summary>
    class function PopCount32(AValue: UInt32): Int32; static; inline;

    /// <summary>Population count (Hamming weight) of a 64-bit value.</summary>
