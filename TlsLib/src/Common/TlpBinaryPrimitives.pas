...
type
  /// <summary>
  /// Endian-aware byte read/write primitives over TBytes and raw pointers, plus
  /// alignment-safe native-order word load/store.
  /// </summary>
  TBinaryPrimitives = class sealed(TObject)
  strict private
  ...
  public
    ...
    class procedure WriteUInt16LittleEndian(const AData: TBytes; AOffset: Integer; AValue: UInt16); overload; static; inline;
    class procedure WriteUInt32LittleEndian(const AData: TBytes; AOffset: Integer; AValue: UInt32); overload; static; inline;
    class procedure WriteUInt64LittleEndian(const AData: TBytes; AOffset: Integer; AValue: UInt64); overload; static; inline;

    class procedure WriteInt16LittleEndian(const AData: TBytes; AOffset: Integer; AValue: Int16); static; inline;
    class procedure WriteInt32LittleEndian(const AData: TBytes; AOffset: Integer; AValue: Int32); static; inline;
    class procedure WriteInt64LittleEndian(const AData: TBytes; AOffset: Integer; AValue: Int64); static; inline;

    class procedure WriteSingleLittleEndian(const AData: TBytes; AOffset: Integer; AValue: Single); static; inline;
    class procedure WriteDoubleLittleEndian(const AData: TBytes; AOffset: Integer; AValue: Double); static; inline;

    class procedure WriteUInt16BigEndian(const AData: TBytes; AOffset: Integer; AValue: UInt16); overload; static; inline;
    class procedure WriteUInt32BigEndian(const AData: TBytes; AOffset: Integer; AValue: UInt32); overload; static; inline;
    class procedure WriteUInt64BigEndian(const AData: TBytes; AOffset: Integer; AValue: UInt64); overload; static; inline;

    class procedure WriteInt16BigEndian(const AData: TBytes; AOffset: Integer; AValue: Int16); static; inline;
    class procedure WriteInt32BigEndian(const AData: TBytes; AOffset: Integer; AValue: Int32); static; inline;
    class procedure WriteInt64BigEndian(const AData: TBytes; AOffset: Integer; AValue: Int64); static; inline;

    class procedure WriteSingleBigEndian(const AData: TBytes; AOffset: Integer; AValue: Single); static; inline;
    class procedure WriteDoubleBigEndian(const AData: TBytes; AOffset: Integer; AValue: Double); static; inline;

    class function ReadUInt16LittleEndian(const AData: TBytes; AOffset: Integer): UInt16; overload; static; inline;
    class function ReadUInt32LittleEndian(const AData: TBytes; AOffset: Integer): UInt32; overload; static; inline;
    class function ReadUInt64LittleEndian(const AData: TBytes; AOffset: Integer): UInt64; overload; static; inline;

    class function ReadInt16LittleEndian(const AData: TBytes; AOffset: Integer): Int16; static; inline;
    class function ReadInt32LittleEndian(const AData: TBytes; AOffset: Integer): Int32; static; inline;
    class function ReadInt64LittleEndian(const AData: TBytes; AOffset: Integer): Int64; static; inline;

    class function ReadSingleLittleEndian(const AData: TBytes; AOffset: Integer): Single; static; inline;
    class function ReadDoubleLittleEndian(const AData: TBytes; AOffset: Integer): Double; static; inline;

    class function ReadUInt16BigEndian(const AData: TBytes; AOffset: Integer): UInt16; overload; static; inline;
    class function ReadUInt32BigEndian(const AData: TBytes; AOffset: Integer): UInt32; overload; static; inline;
    class function ReadUInt64BigEndian(const AData: TBytes; AOffset: Integer): UInt64; overload; static; inline;

    class function ReadInt16BigEndian(const AData: TBytes; AOffset: Integer): Int16; static; inline;
    class function ReadInt32BigEndian(const AData: TBytes; AOffset: Integer): Int32; static; inline;
    class function ReadInt64BigEndian(const AData: TBytes; AOffset: Integer): Int64; static; inline;

    class function ReadSingleBigEndian(const AData: TBytes; AOffset: Integer): Single; static; inline;
    class function ReadDoubleBigEndian(const AData: TBytes; AOffset: Integer): Double; static; inline;
...
resourcestring
  SOffsetOutOfRange = 'the offset or length is outside the buffer';
...
begin
  // Int64 extent: a near-MaxInt offset must not wrap past the bound
  if (AOffset < 0) or (Int64(AOffset) + ANeeded > Length(AData)) then
    raise EArgumentTlsLibException.CreateRes(@SOffsetOutOfRange);
end;
...
{$IFDEF FPC}
  Result := LEtoN(AValue);
{$ELSE}
  {$IFDEF TLSLIB_LITTLE_ENDIAN}
  Result := AValue;
  {$ELSE}
  Result := TBitOperations.ReverseBytesUInt16(AValue);
  {$ENDIF TLSLIB_LITTLE_ENDIAN}
{$ENDIF FPC}
end;
...
begin
{$IFDEF TLSLIB_REQUIRES_PROPER_ALIGNMENT}
...
// ============================================================================
// Public Write Methods - Little Endian (TBytes)
// ============================================================================
...
// ============================================================================
// Public Write Methods - Big Endian (TBytes)
// ============================================================================
...
// ============================================================================
// Public Read Methods - Little Endian (TBytes)
// ============================================================================
...
// ============================================================================
// Public Read Methods - Big Endian (TBytes)
// ============================================================================
