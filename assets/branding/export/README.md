...
The banner sizes composite the square badge onto a flat `#104d6e` background (see [BRAND.md](../BRAND.md)) rather than stretching it. Regenerate after SVG changes — see the [branding README](../README.md#regenerating-png-and-ico).
